...
<WAITING_REDIRECT_FILE> {REDIRECT_FILE}                        { yybegin(WAITING_REDIRECT_OR_FD); return FishTypes.REDIRECT_FILE; }
...
<WAITING_REDIRECT_DESTINATION> {REDIRECT_FILE}                 { yybegin(WAITING_REDIRECT_OR_FD); return FishTypes.REDIRECT_FILE; }
<WAITING_REDIRECT_DESTINATION> {WHITE_SPACE}                   { yybegin(WAITING_REDIRECT_DESTINATION); return TokenType.WHITE_SPACE; }

<WAITING_REDIRECT_FILE_DESCRIPTOR> {FILE_DESCRIPTOR}           { yybegin(WAITING_REDIRECT_OR_FD); return FishTypes.FILE_DESCRIPTOR; }
...
<WAITING_REDIRECT_OR_FD> {FILE_DESCRIPTOR}                     { yybegin(WAITING_REDIRECTS); return FishTypes.FILE_DESCRIPTOR; }
<WAITING_REDIRECT_OR_FD> {REDIRECT_INPUT_SYMBOLE}              { yybegin(WAITING_REDIRECT_FILE); return FishTypes.REDIRECT_SYMBOLE; }
<WAITING_REDIRECT_OR_FD> {REDIRECT_OUTPUT_SYMBOLE}             { yybegin(WAITING_REDIRECT_DESTINATION); return FishTypes.REDIRECT_SYMBOLE; }
<WAITING_REDIRECT_OR_FD> {WHITE_SPACE}                         { yybegin(WAITING_REDIRECT_OR_FD); return TokenType.WHITE_SPACE; }
<WAITING_REDIRECT_OR_FD> {CRLF}                                { yybegin(YYINITIAL); return TokenType.WHITE_SPACE; }
