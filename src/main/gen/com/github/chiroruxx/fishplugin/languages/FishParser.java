...
public class FishParser implements PsiParser, LightPsiParser {
  ...
  /* ********************************************************** */
  // (ARG|STRING) {SEPARATOR (ARG|STRING)}*
  ...
  /* ********************************************************** */
  // COMMAND [SEPARATOR args] [SEPARATOR REDIRECT REDIRECT_FILE]
